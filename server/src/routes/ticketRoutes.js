...
export function registerTicketRoutes(app) {
  app.get('/api/bookings/:ref/tickets', async (req, res) => {
    try {
      const { ref } = req.params;
      const booking = await get(`SELECT b.*, s.date as session_date, s.time as session_time, s.is_special_event, s.event_title,
      ...
      console.error('GET /api/bookings/:ref/tickets failed:', err);
