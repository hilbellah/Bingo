...
const TABLES = [
  { name: 'sessions',             cols: ['id', 'date', 'time', 'cutoff_time', 'sales_cutoff_at', 'is_available', 'created_at', 'is_special_event', 'event_title', 'event_description', 'session_type', 'deleted_at'] },
