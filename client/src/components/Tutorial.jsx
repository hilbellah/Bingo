    ...
    <div style={styles.body}>
      ...
      <div style={styles.container}>
        ...
        <Step number={2} title="Choose a Session (Date & Time)">
          ...
          <p style={{ marginTop: '20px', marginBottom: '12px' }}>When you <strong>click a special event session</strong>, the floor map loads with the event's custom configuration. The bottom banner shows the event title and all <strong>450 seats</strong> are available.</p>
          <ul style={styles.ul}>
          ...
          <img src="/screenshots/step2-special-selected.png" alt="Special event selected showing 450 available chairs and event banner" style={styles.img} />
        </Step>

        <Step number={3} title="Select Your Seats on the Floor Map">
          <ul style={styles.ul}>
            <li style={styles.li}>A <strong>75-table floor plan</strong> appears showing the venue layout (tables 1-75).</li>
        ...
        <Step number={7} title="Configure Event Packages">
          ...
          <Note label="Behind the scenes">450 seats (75 tables x 6 chairs) are automatically generated. Custom packages are saved for this event only.</Note>
